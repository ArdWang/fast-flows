...
import '../core/flows.dart' as flow_core;
...
typedef OnTap = void Function(FlowsSnackBar snack);
typedef OnHover = void Function(FlowsSnackBar snack, SnackHoverState snackHoverState);
typedef SnackbarStatusCallback = void Function(SnackbarStatus status);

/// FlowsSnackBar - Custom snackbar similar to GetX
class FlowsSnackBar extends StatefulWidget {
  ...
  @override
  State createState() => FlowsSnackBarState();
}

class FlowsSnackBarState extends State<FlowsSnackBar> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    assert(
        ...
        '''You need to either use message[String], or messageText[Widget] or define a userInputForm[Form] in FlowsSnackbar''');
