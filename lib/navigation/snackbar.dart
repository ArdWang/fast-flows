/// SnackPosition - Position of the snackbar
library;

import 'dart:async';
import 'dart:ui';
import 'package:flutter/material.dart';
import '../core/flow.dart' as flow_core;
...
typedef OnTap = void Function(FlowSnackBar snack);
typedef OnHover = void Function(FlowSnackBar snack, SnackHoverState snackHoverState);
typedef SnackbarStatusCallback = void Function(SnackbarStatus status);

/// FlowSnackBar - Custom snackbar similar to GetX
class FlowSnackBar extends StatefulWidget {
  ...
  /// Give to FlowSnackbar a gradient background
  ...
  @override
  State createState() => FlowSnackBarState();
}

class FlowSnackBarState extends State<FlowSnackBar> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    assert(
        ...
        '''You need to either use message[String], or messageText[Widget] or define a userInputForm[Form] in FlowSnackbar''');
...
class SnackbarController {
  ...
  final FlowSnackBar snackBar;

  SnackbarController(this.snackBar);

  static bool get isSnackbarBeingShown => _isShowing;
  ...
  Future<void> show() async {
    ...
    final navigatorState = flow_core.Flow.navigator;
    if (navigatorState == null) {
      throw 'Navigator not found. Did you forget to wrap your app with FlowMaterialApp?';
    }
  ...
  Future<void> dismiss() async {
    snackBar.snackbarStatus?.call(SnackbarStatus.closing);
    _overlayEntry?.remove();
    _overlayEntry = null;
    _isShowing = false;
    snackBar.snackbarStatus?.call(SnackbarStatus.closed);
  }
}
